...
## Operations and Skill Registry Quick Reference

The release baseline keeps only the main branch. Skill Registry GC is preview-only by default; apply requires --apply --confirm GC and supports gc-rollback. Verify daemon restarts with ai-memory-hub daemon status.

See docs/operations-and-branch-policy.md for the full restart and branch checklist.
