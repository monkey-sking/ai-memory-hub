...
const labels = {
  zh: {
    ...
    dispatchLogs: '运行日志',
    dispatchActive: '活跃调度',
    dispatchRecentRuns: '最近运行记录',
    dispatchTotalRuns: '运行记录总数',
    dispatchSummaryNote: '调度只处理当前待处理事项',
    settingsPanel: '运行偏好',
    yes: '是',
    no: '否',
    syncInbox: '同步待处理事项',
    ...
    loadingMore: '加载更多…',
    loadMore: '加载更多',
    // Paged lists only filter the rows already fetched, so both the count chip and the
    // empty state must say how far the search actually reached (prefix + N + suffix).
    partialScopePrefix: '仅搜索了已加载的',
    partialScopeSuffix: '条，服务器上还有未加载的数据',
    noMatchesInLoaded: '已加载的数据中没有匹配项',
    kind: '类型',
    source: '来源',
    save: '保存',
    addTask: '新增任务',
    ...
    confirmCancelTask: '取消该任务？',
    confirmCancelTaskHint: '取消后任务会从列表中消失，控制台目前无法恢复已取消的任务。',
    confirmCancelTaskAction: '确认取消任务',
    keepTask: '保留任务',
    purge: '彻底删除',
    purgeTask: '物理删除任务',
    purgeConfirm: '确认删除',
    ...
    tasksByTool: '任务按工具分布',
    workflowsByStatus: '工作流状态分布',
    radioByType: 'Radio 类型分布',
    relayByState: 'Relay 状态分布',
    relayThreads: 'Relay 线程',
    ...
    resultCount: '结果数',
    searchPrompt: '输入查询以搜索',
    searchPromptHint: '可跨记忆、任务、Radio 与工作流检索；选择左侧分面可缩小范围。',
    elapsed: '耗时',
    range: '时间范围',
    sort: '排序',
    relevance: '相关性',
    ...
    pruneCandidates: '可清理',
    createBackup: '创建备份',
    createBackupHint: '为当前记忆库创建一份新的备份集，填写原因便于日后识别。',
    backupReason: '备份原因',
    inspectBackup: '查看文件',
    previewRestore: '恢复预览',
    deleteSelected: '删除选中',
    selectBackup: '选择备份',
    deleteConfirmTitle: '删除选中的备份',
    deleteConfirmBody: '此操作不可撤销，将永久删除选中的 {n} 个备份集。',
    ...
    archive: '归档',
    archiveProject: '归档项目',
    confirmArchiveProject: '项目会被标记为归档并从可见列表移除，之后仍可在编辑弹窗中改回其他状态。',
    ...
    chat: {
      title: '对话',
      subtitle: '向本机 Agent 发送 Radio 消息',
      language: 'English',
      empty: '暂无消息',
      placeholder: '输入消息',
      send: '发送',
  ...
  en: {
    ...
    dispatchActive: 'Active dispatches',
    dispatchRecentRuns: 'Recent run records',
    dispatchTotalRuns: 'Total run records',
    dispatchSummaryNote: 'Dispatch only processes currently pending items',
    ...
    loadMore: 'Load more',
    partialScopePrefix: 'Searched only the',
    partialScopeSuffix: 'loaded items; more exist on the server',
    noMatchesInLoaded: 'No matches among the loaded items',
    kind: 'Kind',
    source: 'Source',
    save: 'Save',
    addTask: 'Add task',
    ...
    confirmCancelTaskHint: 'The task disappears from the list, and this console currently cannot restore a cancelled task.',
    confirmCancelTaskAction: 'Cancel task',
    keepTask: 'Keep task',
    purge: 'Purge',
    ...
    searchPromptHint: 'Searches across memories, tasks, radio, and workflows. Pick a facet on the left to narrow it down.',
    elapsed: 'Elapsed',
    range: 'Range',
    sort: 'Sort',
    relevance: 'Relevance',
    ...
    createBackupHint: 'Create a new backup set of the current memory store. The reason helps you identify it later.',
    backupReason: 'Backup reason',
    inspectBackup: 'Inspect files',
    previewRestore: 'Restore preview',
    deleteSelected: 'Delete selected',
    selectBackup: 'Select backup',
    deleteConfirmTitle: 'Delete selected backups',
    deleteConfirmBody: 'This cannot be undone. The {n} selected backup sets will be permanently deleted.',
    ...
    confirmArchiveProject: 'The project is marked as archived and drops out of the visible list. You can set its status back later from the edit dialog.',
    // Agent execution panel
    ...
    chat: {
      title: 'Chat',
      subtitle: 'Send radio messages to local agents',
      language: '中文',
      empty: 'No messages',
